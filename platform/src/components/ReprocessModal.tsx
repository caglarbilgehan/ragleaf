      ...
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Yeniden İşle</h3>
            ...
            <label className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-gray-800">Görselleri Yeniden Çıkart</span>
                </div>
            ...
            <label className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50 cursor-pointer">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-gray-800">Görsel OCR'ı Tekrarla</span>
                </div>
                <p className="text-xs text-gray-500 mt-1">
