        ...
        <div className="max-h-64 overflow-y-auto">
          {sortedPages.map((page) => (
            <button key={page.page_number} onClick={() => onPageChange(page.page_number)}
              className={`w-full flex items-center justify-between p-3 text-left hover:bg-gray-50 border-b border-gray-100 last:border-b-0 transition-colors ${
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-sm ${page.page_number === currentPage ? 'font-semibold text-blue-700' : 'text-gray-700'}`}>
