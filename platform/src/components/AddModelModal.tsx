        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-4">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-300">Stream Yanıtları</span>
                </label>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-white/[0.1] rounded"
                  />
                  <span className="ml-2 text-sm text-gray-300">Varsayılan Model</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-3 mt-8 pt-6 border-t border-white/[0.06]">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-sm font-medium text-gray-300 bg-dark-800/60 border border-white/[0.1] rounded-md hover:bg-dark-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              İptal
            </button>
            <button
